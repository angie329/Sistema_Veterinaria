...
const tableName = "Gen_MetodoPago";
const idField = "Gen_id_metodo_pago";
const fields = [
...
metodoPagoRouter.get("/:id", async (req, res) => {
  try {
...
metodoPagoRouter.put("/:id", async (req, res) => {
  try {
...
metodoPagoRouter.delete("/:id", async (req, res) => {
  try {
