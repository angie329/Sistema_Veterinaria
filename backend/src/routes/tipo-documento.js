...
const tableName = "Gen_TipoDocumento";
const idField = "Gen_id_tipo_documento";
const fields = [
...
tipoDocumentoRouter.get("/", async (req, res) => {
  try {
...
tipoDocumentoRouter.get("/:id", async (req, res) => {
  try {
...
tipoDocumentoRouter.post("/", async (req, res) => {
  try {
...
tipoDocumentoRouter.put("/:id", async (req, res) => {
  try {
...
tipoDocumentoRouter.delete("/:id", async (req, res) => {
  try {
