...
const tableName = "Gen_Operadora";
const idField = "Gen_id_operadora";
const fields = [
...
operadoraRouter.get("/", async (req, res) => {
  try {
...
operadoraRouter.get("/:id", async (req, res) => {
  try {
...
operadoraRouter.post("/", async (req, res) => {
  try {
...
operadoraRouter.put("/:id", async (req, res) => {
  try {
...
operadoraRouter.delete("/:id", async (req, res) => {
  try {
