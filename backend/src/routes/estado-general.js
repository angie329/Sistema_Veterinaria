...
const tableName = "Gen_EstadoGeneral";
const idField = "Gen_id_estado_general";
const fields = [
...
const handleError = (res, operation, error) => {
  ...
  // Incluimos el mensaje de error de la DB solo para crear/actualizar, donde es más relevante.
...
estadoGeneralRouter.get("/", async (req, res) => {
  try {
...
estadoGeneralRouter.get("/:id", async (req, res) => {
  try {
...
estadoGeneralRouter.post("/", async (req, res) => {
  try {
...
estadoGeneralRouter.put("/:id", async (req, res) => {
  try {
...
estadoGeneralRouter.delete("/:id", async (req, res) => {
  try {
