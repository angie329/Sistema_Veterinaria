...
const tableName = "Gen_IVA";
const idField = "Gen_id_iva";
const fields = [
...
ivaRouter.get("/:id", async (req, res) => {
  try {
...
ivaRouter.put("/:id", async (req, res) => {
  try {
...
ivaRouter.delete("/:id", async (req, res) => {
  try {
