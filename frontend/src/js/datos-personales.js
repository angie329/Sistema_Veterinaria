...
const tableConfigs = {
  "genero-sexo": {
    tableName: "genero-sexo",
    idField: "Gen_id_genero_sexo",
    mainFields: ["Gen_nombre"],
    allFields: ["Gen_modulo_origen", "Gen_nombre", "Gen_id_estado_general"],
  },
  "estado-civil": {
    tableName: "estado-civil",
    idField: "Gen_id_estado_civil",
    mainFields: ["Gen_nombre"],
    allFields: ["Gen_modulo_origen", "Gen_nombre", "Gen_id_estado_general"],
  },
  "tipo-documento": {
    tableName: "tipo-documento",
    idField: "Gen_id_tipo_documento",
    mainFields: ["Gen_codigo", "Gen_nombre"],
    allFields: ["Gen_modulo_origen", "Gen_codigo", "Gen_nombre", "Gen_descripcion", "Gen_id_estado_general"],
  },
};
...
function openModal(tableKey) {
  ...
  const titles = {
    "genero-sexo": "Nuevo Género/Sexo",
    "estado-civil": "Nuevo Estado Civil",
    "tipo-documento": "Nuevo Tipo Documento",
  };
...
async function editRecord(tableKey, id) {
  ...
  try {
    ...
    const titles = {
      "genero-sexo": "Editar Género/Sexo",
      "estado-civil": "Editar Estado Civil",
      "tipo-documento": "Editar Tipo Documento",
    };
